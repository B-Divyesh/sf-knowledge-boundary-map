...
The 1200×630 `public/assets/social-card.webp` and 180×180 `public/apple-touch-icon.png` are cropped, optimized derivatives of that same original hero artwork, generated 2026-08-30 with ImageMagick. They add social and device metadata without introducing a new visual source or license.
